...
python3 gov/verify_sim.py      # 40 — economy, upkeep, permanence, lineage, governance, the map
...
| `/map` | **The settlement as a place** — a live canvas of the town: every built development on its own tile (placed at build time, spiralling out from the town centre), condition bars on worn assets, villagers afield at their resource grounds, the herald at the gate |
