...
| `harness/builder` | Software at real scale | the repo's test suite | **the merge** | **running unattended** — worktree per task, iterative attempts, human merge gate (`builder.py`) |
